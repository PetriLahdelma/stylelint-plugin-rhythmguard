...
Generated by `npm run bench:quiet` on 2026-09-17. Checkouts and raw results live under `benchmarks/quiet/` and are not committed; the manifest (`repos.json`), the classification rules (`noise-rules.json`) and any per-repo review labels (`labels/<repo>.json`) are.
...
| [primer-css](https://github.com/primer/css.git) | `72564a3` | 113 | 0 | 103 | 103 | 0 | 0 | 0% | 116 | scanned-css (46 tokens) |
