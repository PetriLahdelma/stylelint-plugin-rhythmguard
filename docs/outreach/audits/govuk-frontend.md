# Spacing scale audit: 21 literal spacing values off your own token scale
...
**What it found.** Scale `0, 5, 10, 15, 20, 25, 30, 40, 50, 60` inferred from your own spacing tokens in the stylesheets. 21 literal spacing values are off that scale.

- Values: `2px` ×6, `14px` ×2, `3px` ×2, `8px` ×2, `-2px` ×1
- Properties: `margin-bottom` ×4, `margin-top` ×4, `padding` ×3, `padding-bottom` ×3, `padding-left` ×3
