# Spacing scale audit: 569 literal spacing values off your own token scale
...
**What it found.** Scale `0, 2, 4, 6, 8, 10, 12, 14, 16, 20, 24, 28, 32, 36, 40, 44, 48, 56, 64, 80, 96, 112, 128, 144, 160, 176, 192, 208, 224, 240, 256, 288, 320, 384` inferred from your own spacing tokens in the stylesheets. 569 literal spacing values are off that scale.

- Values: `5px` ×147, `0.15em` ×38, `3px` ×36, `15px` ×34, `0.35em` ×27
- Properties: `padding` ×193, `margin` ×60, `margin-right` ×60, `margin-left` ×59, `margin-bottom` ×48
