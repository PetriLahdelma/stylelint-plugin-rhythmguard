...
**What was run.** `npx rhythmguard audit . --scale auto` at `d35fb6f` over `src`. Hairlines of one pixel or less, percentages, and generated or test paths are excluded. Anyone can reproduce it in a checkout of that commit.
